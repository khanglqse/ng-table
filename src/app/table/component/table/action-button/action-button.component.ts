...
import { ButtonSetting, TableSetting, ActionButtonSetting } from 'src/app/table/models/settings.model';
import { TableActionButtonTemplate } from 'src/app/table/directive/table-directive.directive';
...
export class ActionButtonComponent implements OnInit {
  ...
  @ViewChild('_actionButtonTemplate', {static: true}) public actionButtonTemplate;
  constructor() { }
