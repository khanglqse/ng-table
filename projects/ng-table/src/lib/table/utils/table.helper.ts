...
export class TableHelper {
  ...
  handleExpandRowData(){
    ...
    const rowEmbeddedView = this.template.templateRef.createEmbeddedView({...this.rowData})
  ...
  handleCollapseRow(templateEl){
    ...
    if(this.rowElement.nextElementSibling.attributes.getNamedItem('row-expanded')){
