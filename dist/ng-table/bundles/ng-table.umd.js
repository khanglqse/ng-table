(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/router'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ng-table', ['exports', '@angular/core', 'rxjs', '@angular/common/http', 'rxjs/operators', '@angular/platform-browser', '@angular/router', '@angular/forms'], factory) :
    (global = global || self, factory(global['ng-table'] = {}, global.ng.core, global.rxjs, global.ng.common.http, global.rxjs.operators, global.ng.platformBrowser, global.ng.router, global.ng.forms));
}(this, (function (exports, core, rxjs, http, operators, platformBrowser, router, forms) { 'use strict';
    ...
    var NgTableModule = /** @class */ (function () {
        ...
        NgTableModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [platformBrowser.BrowserModule, router.RouterModule, http.HttpClientModule, forms.FormsModule],
                        exports: [
                            NgTableComponent,
                            TableHeaderTemplate,
                            TableHeaderControlTemplate,
